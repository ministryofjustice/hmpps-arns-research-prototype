//
// Predictors section 1 complete state (hide mark-complete button + success alert)
//
...
export const markSection1Complete = () => {
  ...
  setSectionCompleteSuccessAlertVisible(true)
...
const setSectionCompleteSuccessAlertVisible = (visible) => {
  const alert = document.getElementById('predictors-section-complete-success-alert')
  if (!alert) return
...
export const resetSection1CompleteUi = () => {
  ...
  setSectionCompleteSuccessAlertVisible(false)
}
