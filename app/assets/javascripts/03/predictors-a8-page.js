...
const updateSectionCompleteAlertLink = (checkAnswersHref) => {
  const link = document.querySelector('#predictors-section-complete-success-alert a.govuk-link')
  if (!link) return
...
window.GOVUKPrototypeKit.documentReady(() => {
  ...
  updateSectionCompleteAlertLink(checkAnswersHref)
  initCompletionDate()
