...
import { MISUSED_DRUG_TYPES } from './tiering-b4-drugs.js'
import { hasAlcoholUseInLast3Months, hasAlcoholUseYesAnswer } from './tiering-journey.js'
...
export const buildDynamicTieringSummarySections = (session, offenderFirstName = 'Alex', createRow) => {
  ...
  sections.push({
    ...
    rows: [
      createRow(
        ...
        `Is ${name}'s accommodation suitable?`,
        false,
        'tiering-accommodation-suitable'
      )
    ]
  })
  ...
  sections.push({
    ...
    rows: [
      createRow(
        ...
        `Does ${name} engage in activities that could link to offending?`,
        false,
        'tiering-activities-linked-to-offending'
      ),
      createRow(
      ...
      createRow(
        ...
        `Does ${name} support or excuse criminal behaviour?`,
        false,
        'tiering-support-criminal-behaviour'
      )
    ]
  })
  ...
  const offenceAnalysisRows = [
    ...
    createRow(
      ...
      `Is there evidence that ${name} has ever been a perpetrator of domestic abuse?`,
      false,
      'tiering-domestic-abuse-perpetrator'
    )
  ]
  ...
  sections.push({
    ...
    rows: [
      createRow(
        ...
        `Has ${name} previously been convicted of any of these offences?`,
        true,
        'tiering-serious-harm-convictions'
      )
    ]
  })
